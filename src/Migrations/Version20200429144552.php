 ...
 */
final class Version20200429144552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE representations ADD CONSTRAINT FK_C90A401D0C1FC64 FOREIGN KEY (show_id) REFERENCES `shows` (id) ON DELETE RESTRICT ON UPDATE CASCADE');
        $this->addSql('ALTER TABLE representations ADD CONSTRAINT FK_C90A40164D218E FOREIGN KEY (location_id) REFERENCES locations (id) ON DELETE RESTRICT ON UPDATE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `shows` DROP FOREIGN KEY FK_6C3BF14464D218E');
        $this->addSql('ALTER TABLE `shows` ADD CONSTRAINT FK_320ED90164D218E FOREIGN KEY (location_id) REFERENCES locations (id) ON UPDATE CASCADE');
